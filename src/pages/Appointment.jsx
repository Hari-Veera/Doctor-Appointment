...
const Appointment = () => {
  ...
  const getAvailableSlots = async () => {
    ...
    for(let i = 0; i < 7; i++){
      ...
      //setting end time of the daet with index
  ...
  <div>
    ...
    {docInfo ? (
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
        <div>
